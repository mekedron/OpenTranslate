...
interface ProviderSelectorProps {
  ...
  placeholder?: string
  className?: string
  selectContentProps?: Pick<ComponentProps<typeof SelectContent>, "container" | "positionerClassName" | "align">
}
...
function TranslateGroupedSelect({
  ...
  return (
    ...
    >
      ...
      <SelectContent className="w-fit max-w-(--available-width)" {...selectContentProps}>
        <SelectGroup>
