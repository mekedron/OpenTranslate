...
declare global {
  interface Window {
    __OPENTRANSLATE_HOST_INJECTED__?: boolean
  }
}
...
export default defineContentScript({
  ...
  async main(ctx) {
    ...
    if (window.__OPENTRANSLATE_HOST_INJECTED__)
      return
    window.__OPENTRANSLATE_HOST_INJECTED__ = true
    ...
    if (!isSiteEnabled(siteControlUrl, initialConfig)) {
      window.__OPENTRANSLATE_HOST_INJECTED__ = false
