...
export const MENU_ID_TRANSLATE = "opentranslate-translate"
export const MENU_ID_SELECTION_TRANSLATE = "opentranslate-selection-translate"
export const MENU_ID_SELECTION_CUSTOM_ACTION_PREFIX = "opentranslate-selection-custom-action:"
