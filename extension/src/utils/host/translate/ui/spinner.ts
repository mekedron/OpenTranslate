...
export function createLightweightSpinner(ownerDoc: Document): HTMLElement {
  ...
  spinner.className = "opentranslate-spinner"
  ...
  spinner.style.cssText = `
    ...
    border-top: 1.5px solid var(--opentranslate-muted-foreground) !important;
  ...
  if (!prefersReducedMotion && spinner.animate) {
    ...
    spinner.style.borderTopColor = "var(--opentranslate-muted-foreground)"
  }
