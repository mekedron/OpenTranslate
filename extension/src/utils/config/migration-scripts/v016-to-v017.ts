export function migrate(oldConfig: any): any {
  const isUsingDefaultPrompt = oldConfig.translate.promptsConfig.prompt === "OpenTranslate: TRANSLATE_DEFAULT_PROMPT"
  ...
  const newPromptConfig = {
    ...
    patterns: oldConfig.translate.promptsConfig.patterns.map((pattern: any) => {
      if (pattern.id === "OpenTranslate: TRANSLATE_DEFAULT_PROMPT") {
        return {
          id: "default",
          name: "default",
